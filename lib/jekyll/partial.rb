module Jekyll
  ...
  class Partial
    ...
    #attr_writer :dir
    attr_accessor :payload, :site, :base
    ...
    def initialize(site, payload, base, name)
      @payload = payload
      @base = base
      @site = site
      @name = name
      ...
      self.process(name)
      self.read_yaml(File.join(base), name)
    end
    ...
    def inspect
      "#<Jekyll:Partial @name=#{self.name.inspect}>"
    end
